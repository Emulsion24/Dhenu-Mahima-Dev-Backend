...
import { createSansthan, deleteSansthan, getAllSansthans, getSansthanById, updateSansthan ,reorderSansthans} from '../controllers/datasSangsthan.js';

const router = express.Router();
router.put('/reorder',verifyToken,requireRole(["admin", "subadmin"]),reorderSansthans);
